...
<details><summary>View Screenshot</summary>
    <img src="{{ '/assets/img/features/product-gallery-expanded.webp' | relative_url }}" width="1023" height="682" class="!m-0" alt="Expanded Mode Screenshot" loading="lazy"/>
</details>
...
<details><summary>View Video</summary>
    <video loop controls class="cursor-pointer" src="{{ '/assets/img/features/product-gallery-slider.webm' | relative_url }}" class="!m-0"></video>
</details>
